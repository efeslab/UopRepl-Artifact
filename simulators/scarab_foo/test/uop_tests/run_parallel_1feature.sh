...
do
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          ...
          # $sim_binary --frontend pt --uop_cache_feature $feature_bit --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 19 --uop_cache_usage_count 1 --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log.txt &
          # $sim_binary --perfect_bp 1 --perfect_btb 1 --perfect_ibp 1 --perfect_crs 1 --perfect_cbr_btb 1 --perfect_nt_btb 1 --perfect_mlc 1 --perfect_l1 1 --perfect_icache 1 --perfect_dcache 1 --frontend pt --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 1 --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log.txt &
          $sim_binary --frontend pt --uop_cache_feature $feature_bit --uop_cache_fix_bug $bug_fixed --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 1 --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log.txt &
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          echo $files
          # $sim_binary --perfect_bp 1 --perfect_btb 1 --perfect_ibp 1 --perfect_crs 1 --perfect_cbr_btb 1 --perfect_nt_btb 1 --perfect_mlc 1 --perfect_l1 1 --perfect_icache 1 --perfect_dcache 1 --frontend pt --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 0 --uop_opt_cache_access 0 --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log.txt &
          $sim_binary --frontend pt --uop_cache_feature $feature_bit --uop_cache_fix_bug $bug_fixed --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 0 --uop_opt_cache_access 0 --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log.txt &
      fi
        if ((COUNTER%12==0));  #13
        then
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          ...
          # $sim_binary --frontend pt --uop_cache_feature $feature_bit --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 19 --uop_cache_usage_count 2 --uop_cache_enable_record 1 --footprint "cacheaccess_stream.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log1.txt &
          $sim_binary --frontend pt --uop_cache_feature $feature_bit --uop_cache_fix_bug $bug_fixed --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 2 --uop_cache_enable_record 1 --footprint "pmc_stream.out" --footprint_switch "pmc_stream_switch.out" --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log1.txt &
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          ...
          # # # $sim_binary --frontend pt --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 18 --uop_cache_exe_count 1 --footprint "cacheaccess_stream.out"  --uop_access_count_bit $counter_bit --uop_cache_enable_record 0  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
          # # $sim_binary --frontend pt --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 18 --uop_cache_exe_count 1 --footprint "cacheaccess_stream.out"  --uop_access_count_bit $counter_bit --uop_cache_enable_record 0  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
          # $sim_binary --frontend pt --uop_cache_feature $feature_bit --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 19 --uop_cache_usage_count 2 --uop_cache_enable_record 0 --footprint "cacheaccess_stream.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
          $sim_binary --frontend pt --uop_cache_feature $feature_bit --uop_cache_fix_bug $bug_fixed --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 2 --uop_cache_enable_record 0 --footprint "pmc_stream.out" --footprint_switch "pmc_stream_switch.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          ...
          # $sim_binary --frontend pt --uop_cache_feature $feature_bit --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 19 --uop_cache_usage_count 2 --uop_cache_enable_record 0 --footprint "cacheaccess_stream_w8.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
          $sim_binary --frontend pt --uop_cache_feature $feature_bit --uop_cache_fix_bug $bug_fixed --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 2 --uop_cache_enable_record 0 --footprint "pmc_stream_w8.out" --footprint_switch "pmc_stream_switch_w8.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
