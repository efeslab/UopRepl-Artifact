...
do
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          ...
          $sim_binary --frontend pt --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 2 --uop_cache_enable_record 1 --footprint "pmc_stream.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log1.txt &
    ...
    do
      ...
      if (( COUNTER > 0 )); then
          ...
          $sim_binary --frontend pt --oracle_perfect_uop_cache 0 --uop_cache_repl_policy 20 --uop_cache_usage_count 2 --uop_cache_enable_record 0 --footprint "pmc_stream_w8.out"  --cbp_trace_r0=$files --fetch_off_path_ops=false --inst_limit 99000000 --btb_entries 8192 --btb_assoc 4 --enable_crs 1 --crs_entries 32 --enable_ibp 1 --crs_realistic 1 --use_pat_hist 1 --bp_mech tagescl --btb_mech 0 --fdip_enable 0 &> log2.txt &
