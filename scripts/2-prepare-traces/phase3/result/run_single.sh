sim_binary="$UOP_SIMULATOR_ROOT/scarab_getRipeTrace/src/scarab";
...
ProcessPath="../process"
OracleFooTraceBase="$UOP_SCRIPTS_ROOT/2-prepare-traces/phase2/result"
...
(   
    ...
    cat $OutputFolder/log.txt | grep "," | grep -v "e" > $dir/../UOP/$testSet.csv
)&
